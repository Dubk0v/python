...
Подсказка:
постарайтесь по возможности реализовать в проекте «Склад оргтехники» максимум возможностей,
...
class Printer(OfficeEquipment):
    def to_print(self):
        return f'распечать что нибудь {self.numb} раз)'


class Scanner(OfficeEquipment):
    def to_scan(self):
        return f'сканировать что нибудь {self.numb} раз)'
